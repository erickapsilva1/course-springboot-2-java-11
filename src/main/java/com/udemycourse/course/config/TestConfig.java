...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Order o1 = new Order(null, Instant.parse("2021-07-20T19:00:00Z"), u1);
		Order o2 = new Order(null, Instant.parse("2021-07-20T18:15:00Z"), u2);
		Order o3 = new Order(null, Instant.parse("2021-07-20T19:10:00Z"), u1);
